$(document).ready(function () {
    ...
    $(document).ready(function () {
            ...
            data: {
                ...
                onclick: function (d, node) {
                    if (d.hasOwnProperty("children")) {
                        ...
                        d3.selectAll(".node:not(.selected)")
                            .transition()
                            .duration(100)
                            .attr("width", 0)
                            .attr("height", 0);
                        d3.select(node).select(".node")
                            .transition()
                            //.duration(100)
                            .style("fill-opacity", 0.1)
                            .attr("x", 0)
                            .attr("y", 0)
                            .attr("width", chart._config.width)
                            .attr("height", chart._config.height)
                            .each("end", function () {
        ...
        $("input[name='autosize']").on("change", function (evt) {
    ...
    $("ol.breadcrumb").on('click', 'li a', function (event) {
        ...
        breadcrumb();
        chart.data(nodes[nodes.length - 1]);
    });
